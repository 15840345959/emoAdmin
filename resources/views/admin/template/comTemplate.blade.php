...
@section('content')
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 公司模板管理 <span
                class="c-gray en">&gt;</span> 公司模板管理 <a class="btn btn-success radius r btn-refresh"
                                                        style="line-height:1.6em;margin-top:3px"
                                                        href="javascript:location.replace(location.href);" title="刷新"
                                                        onclick="location.replace('{{URL::asset('/admin/template/comTemplate')}}');"><i
        ...
        <table class="table table-border table-bordered table-bg" style="margin-top: 3rem;">
            ...
            <tr class="text-c">
                ...
                <td class="td-manage">
                    ...
                    <a title="流程模板管理" href="{{ URL::asset('/admin/template/processTem') }}" class="ml-5" style="text-decoration:none">
